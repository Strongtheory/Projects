...
public class AbaloneTest {
    ...
    private static DataSet solar = solarSet();
    ...
    public static void main(String[] args) {
        for(int i = 0; i < oa.length; i++) {
            ...
            nnop[i] = new NeuralNetworkOptimizationProblem(solar, networks[i], measure);
        }
    ...
    ////////////////////////////////////////////////////
    private static DataSet solarSet() {
        DataSet set = null;
        try {
            /* Alternate between training and testing here!!!!!!!!! */
            set = (new ArffDataSetReader((new File(".")).getAbsolutePath() + "training.arff")).read();
