<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT username FROM Manager WHERE username = '$myusername' and password = '$mypassword'";
      ...
      if($count == 1) {
         ...
         header("Location: chooseFunctionalityManager.html");
      }else {
