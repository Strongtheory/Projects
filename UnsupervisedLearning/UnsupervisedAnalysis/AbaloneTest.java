...
public class AbaloneTest {
    ...
    private static DataSet assignment3 = assignment3Set();
    ...
    public static void main(String[] args) {
        for(int i = 0; i < oa.length; i++) {
            ...
            nnop[i] = new NeuralNetworkOptimizationProblem(assignment3, networks[i], measure);
        }
    ...
    private static DataSet assignment3Set() {
        DataSet set = null;
        try {
            set = (new ArffDataSetReader((new File(".")).getAbsolutePath() + "seismic-rs.arff")).read();
