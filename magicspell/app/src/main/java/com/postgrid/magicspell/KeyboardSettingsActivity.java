 ...
 */
public class KeyboardSettingsActivity extends AppCompatPreferenceActivity {
    /**
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            //bindPreferenceSummaryToValue(findPreference("seekBar"));
        }
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), KeyboardSettingsActivity.class));
                return true;
            }
