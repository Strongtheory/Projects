...
class Agent:
    ...
    def Solve(problem):
        ...
        if problem.problemType == '2x2':
            ...
            h = problem.figures['H']
            #####################################################################################
            count = cm.pixelCount(problem, [a, b, c, d, e, f, g, h], options_three)
            xor = cm.xorCheck(problem, [a, b, c, d, e, f, g, h], options_three)
            half = cm.invertHalf(problem, [a, b, c, d, e, f, g, h], options_three)
            solution = cm.finalSolve3(count, xor, half)
            #####################################################################################
        return solution
